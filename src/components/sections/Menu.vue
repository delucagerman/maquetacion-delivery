		...
		<div class="flex content-around flex-wrap font-plex">
			<div class="w-1/3 p-2">
				...
				<div class="pr-28 mt-2">
					Te ofrecemos los menús perfectos para tus eventos, comidas
					de equipo o reuniones en tu oficina.
				</div>
			...
			<div class="w-2/3 p-2">
				...
				<div class="pr-28 mt-2">
					Una prueba de que puedes disfrutar de la mejor comida cada
					día a precios asequibles para tu bolsillo.
				</div>
				<span class="block my-2 text-green-901"
			...
			<div class="w-2/3  p-2">
				...
				<div class="pr-28 mt-2">
					¿Necesitas una motivo para reunirte con tus amigos? Pedir
					comida es la excusa perfecta para compartir y disfrutar.
				</div>
				<span class="block my-2 text-green-901"
					>Ver Para compartir
					<i class="fas fa-long-arrow-alt-right"></i
			...
			<div class="w-1/3  p-2">
				...
				<span class="block my-2 text-green-901"
					>Ver Comida sana <i class="fas fa-long-arrow-alt-right"></i
				></span>
			</div>
			<div class="w-2/3 p-2">
				<div
			...
			<div class="w-2/3 p-2">
				...
				<div class="pr-28 mt-2">
					Esos grandes clásicos a los que siempre vuelves porque nunca
					fallan.
				</div>
				<span class="block my-2 text-green-901"
